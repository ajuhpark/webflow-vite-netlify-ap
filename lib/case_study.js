...
function case_study() {
  ...
  function init(){
    ...
    case_study_tl
      ...
      .from('.project_hero_image_container', { xPercent: -101, duration: 1.8, ease: 'circ.out' }, 'case_study_tl+=.8')
      .from('.project_hero_image', { xPercent: 101, duration: 1.8, ease: 'circ.out' }, 'case_study_tl+=.8')
