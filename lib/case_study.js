...
function case_study() {
  ...
  function init(){
    ...
    case_study_tl
      ...
      .from(split_cs.chars, {yPercent: 110, opacity: 0, stagger: 0.011, duration: .55, ease:"linear"}, 'case_study_tl+=.4')
      .from('.project_hero_image_container', { xPercent: -101, duration: 1.3, ease: 'circ.out' }, 'case_study_tl+=.8')
      .from('.project_hero_image', { xPercent: 101, duration: 1.3, ease: 'circ.out' }, 'case_study_tl+=.8')
      .from('.project_body_section', { opacity: 0, duration: 1.2 }, 'case_study_tl+=1.6')
    }
