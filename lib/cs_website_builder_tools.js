...
function cs_website_builder_tools() {
  ...
  function init(){
    ...
    cs_website_builder_tools_tl
      ...
      .from(split_cs.chars, {yPercent: 110, opacity: 0, stagger: 0.011, duration: .55, ease:"linear"}, 'cs_website_builder_tools_tl+=.4')
      .from('.project_hero_image_container', { xPercent: -101, duration: 1.3, ease: 'circ.out' }, 'cs_website_builder_tools_tl+=.6')
      .from('.project_hero_image', { xPercent: 101, duration: 1.3, ease: 'circ.out' }, 'cs_website_builder_tools_tl+=.6')
      .from('.project_body_section', { opacity: 0, duration: 1.2 }, 'cs_website_builder_tools_tl+=1.6')
    }
