...
function cs_website_builder_tools() {
  ...
  function init(){
    ...
    cs_website_builder_tools_tl
      ...
      .from('.project_hero_image_container', { xPercent: -101, duration: 1.8, ease: 'circ.out' }, 'cs_website_builder_tools_tl+=.6')
      .from('.project_hero_image', { xPercent: 101, duration: 1.8, ease: 'circ.out' }, 'cs_website_builder_tools_tl+=.6')
